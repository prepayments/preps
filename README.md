...
To build the final jar and optimize the preps application for production, run:
...
Then navigate to [http://localhost:11001](http://localhost:11001) in your browser.
