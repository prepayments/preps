    ...
    >
      ...
      <ul class="dropdown-menu" ngbDropdownMenu aria-labelledby="reports-menu">
        <li>
          <a
            class="dropdown-item"
            routerLink="reporting/amortization-entries"
            routerLinkActive="active"
            [routerLinkActiveOptions]="{ exact: true }"
          >
        ...
        <li>
          <a
            class="dropdown-item"
            routerLink="reporting/prepayment-entries"
            routerLinkActive="active"
            [routerLinkActiveOptions]="{ exact: true }"
          >
            <fa-icon icon="asterisk" fixedWidth="true"></fa-icon>
        ...
        <li>
          <a
            class="dropdown-item"
            routerLink="reporting/registered-suppliers"
            routerLinkActive="active"
            [routerLinkActiveOptions]="{ exact: true }"
          >
            <fa-icon icon="asterisk" fixedWidth="true"></fa-icon>
        ...
        <li>
          <a
            class="dropdown-item"
            routerLink="reporting/service-outlets"
            routerLinkActive="active"
            [routerLinkActiveOptions]="{ exact: true }"
          >
            <fa-icon icon="asterisk" fixedWidth="true"></fa-icon>
        ...
        <li>
          <a
            class="dropdown-item"
            routerLink="reporting/transaction-accounts"
            routerLinkActive="active"
            [routerLinkActiveOptions]="{ exact: true }"
          >
            <fa-icon icon="asterisk" fixedWidth="true"></fa-icon>
        ...
        >
          <li>
            <a class="dropdown-item" routerLink="report-type" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }">
              <fa-icon icon="asterisk" fixedWidth="true"></fa-icon>
          ...
          <li>
            <a
              class="dropdown-item"
              routerLink="report-request-event"
              routerLinkActive="active"
              [routerLinkActiveOptions]="{ exact: true }"
            >
              <fa-icon icon="asterisk" fixedWidth="true"></fa-icon>
