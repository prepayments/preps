...
import { AdditionMenuComponent } from './addition-menu.component';
...
@NgModule({
  declarations: [
    ...
    ModelsMenuComponent,
    AboutMenuComponent,
    AdditionMenuComponent
  ],
  imports: [CommonModule, PrepsSharedModule, NavigationRoutingModule],
  exports: [ReportMenuComponent, ExportMenuComponent, ImportMenuComponent, ModelsMenuComponent, AboutMenuComponent, AdditionMenuComponent],
  entryComponents: [
    ReportMenuComponent,
    ExportMenuComponent,
    ImportMenuComponent,
