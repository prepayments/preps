...
/**
 * Criteria class for the {@link io.github.prepayments.domain.UpdatedAmortizationEntry} entity. This class is used
 * in {@link io.github.prepayments.web.rest.UpdatedAmortizationEntryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /updated-amortization-entries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class UpdatedAmortizationEntryCriteria implements Serializable, Criteria {
    ...
    private LocalDateFilter dateOfUpdate;

    private StringFilter reasonForUpdate;

    private LongFilter prepaymentEntryId;

    public UpdatedAmortizationEntryCriteria(){
    }

    public UpdatedAmortizationEntryCriteria(UpdatedAmortizationEntryCriteria other){
        ...
        this.dateOfUpdate = other.dateOfUpdate == null ? null : other.dateOfUpdate.copy();
    ...
    @Override
    public UpdatedAmortizationEntryCriteria copy() {
        return new UpdatedAmortizationEntryCriteria(this);
    }
    ...
    public LocalDateFilter getDateOfUpdate() {
        return dateOfUpdate;
    }

    public void setDateOfUpdate(LocalDateFilter dateOfUpdate) {
    ...
    public boolean equals(Object o) {
        ...
        final UpdatedAmortizationEntryCriteria that = (UpdatedAmortizationEntryCriteria) o;
        return
            ...
            Objects.equals(dateOfUpdate, that.dateOfUpdate) &&
    ...
    public String toString() {
        return "UpdatedAmortizationEntryCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (dateOfUpdate != null ? "dateOfUpdate=" + dateOfUpdate + ", " : "") +
