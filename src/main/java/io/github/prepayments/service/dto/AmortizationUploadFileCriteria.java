...
/**
 * Criteria class for the {@link io.github.prepayments.domain.AmortizationUploadFile} entity. This class is used in {@link io.github.prepayments.web.rest.AmortizationUploadFileResource} to receive all
 * the possible filtering options from the Http GET request parameters. For example the following could be a valid request: {@code /amortization-upload-files?id
...
public class AmortizationUploadFileCriteria implements Serializable, Criteria {
    ...
    public String toString() {
        return "AmortizationUploadFileCriteria{" + (id != null ? "id=" + id + ", " : "") + (periodFrom != null ? "periodFrom=" + periodFrom + ", " : "") +
