...
public class PrepaymentDataEntryFileDTO implements Serializable {
    ...
    public String toString() {
        return "PrepaymentDataEntryFileDTO{" + "id=" + getId() + ", periodFrom='" + getPeriodFrom() + "'" + ", periodTo='" + getPeriodTo() + "'" + ", dataEntryFile='" + getDataEntryFile() + "'" +
            ", uploadProcessed='" + isUploadProcessed() + "'" + ", uploadSuccessful='" + isUploadSuccessful() + "'" + ", entriesCount=" + getEntriesCount() + ", fileToken='" + getFileToken() + "'" +
            "}";
    }
}
