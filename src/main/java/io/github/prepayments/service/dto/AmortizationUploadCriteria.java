...
public class AmortizationUploadCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(accountName, that.accountName) && Objects.equals(particulars, that.particulars) &&
            Objects.equals(serviceOutletCode, that.serviceOutletCode) && Objects.equals(prepaymentAccountNumber, that.prepaymentAccountNumber) &&
            Objects.equals(expenseAccountNumber, that.expenseAccountNumber) && Objects.equals(prepaymentTransactionId, that.prepaymentTransactionId) &&
            Objects.equals(prepaymentTransactionDate, that.prepaymentTransactionDate) && Objects.equals(prepaymentTransactionAmount, that.prepaymentTransactionAmount) &&
            Objects.equals(amortizationAmount, that.amortizationAmount) && Objects.equals(numberOfAmortizations, that.numberOfAmortizations) &&
            Objects.equals(firstAmortizationDate, that.firstAmortizationDate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, accountName, particulars, serviceOutletCode, prepaymentAccountNumber, expenseAccountNumber, prepaymentTransactionId, prepaymentTransactionDate,
                            prepaymentTransactionAmount, amortizationAmount, numberOfAmortizations, firstAmortizationDate);
    }

    @Override
    public String toString() {
        return "AmortizationUploadCriteria{" + (id != null ? "id=" + id + ", " : "") + (accountName != null ? "accountName=" + accountName + ", " : "") +
            (particulars != null ? "particulars=" + particulars + ", " : "") + (serviceOutletCode != null ? "serviceOutletCode=" + serviceOutletCode + ", " : "") +
