...
/**
 * Criteria class for the {@link io.github.prepayments.domain.AmortizationUpload} entity. This class is used in {@link io.github.prepayments.web.rest.AmortizationUploadResource} to receive all the
 * possible filtering options from the Http GET request parameters. For example the following could be a valid request: {@code /amortization-uploads?id
...
public class AmortizationUploadCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(accountName, that.accountName) && Objects.equals(particulars, that.particulars) &&
            Objects.equals(amortizationServiceOutletCode, that.amortizationServiceOutletCode) && Objects.equals(prepaymentServiceOutletCode, that.prepaymentServiceOutletCode) &&
            Objects.equals(prepaymentAccountNumber, that.prepaymentAccountNumber) && Objects.equals(expenseAccountNumber, that.expenseAccountNumber) &&
            Objects.equals(prepaymentTransactionId, that.prepaymentTransactionId) && Objects.equals(prepaymentTransactionDate, that.prepaymentTransactionDate) &&
            Objects.equals(prepaymentTransactionAmount, that.prepaymentTransactionAmount) && Objects.equals(amortizationAmount, that.amortizationAmount) &&
            Objects.equals(numberOfAmortizations, that.numberOfAmortizations) && Objects.equals(firstAmortizationDate, that.firstAmortizationDate) &&
            Objects.equals(monthlyAmortizationDate, that.monthlyAmortizationDate) && Objects.equals(uploadSuccessful, that.uploadSuccessful) && Objects.equals(uploadOrphaned, that.uploadOrphaned) &&
            Objects.equals(originatingFileToken, that.originatingFileToken) && Objects.equals(amortizationTag, that.amortizationTag);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, accountName, particulars, amortizationServiceOutletCode, prepaymentServiceOutletCode, prepaymentAccountNumber, expenseAccountNumber, prepaymentTransactionId,
                            prepaymentTransactionDate, prepaymentTransactionAmount, amortizationAmount, numberOfAmortizations, firstAmortizationDate, monthlyAmortizationDate, uploadSuccessful,
                            uploadOrphaned, originatingFileToken, amortizationTag);
    }

    @Override
    public String toString() {
        return "AmortizationUploadCriteria{" + (id != null ? "id=" + id + ", " : "") + (accountName != null ? "accountName=" + accountName + ", " : "") +
            (particulars != null ? "particulars=" + particulars + ", " : "") + (amortizationServiceOutletCode != null ? "amortizationServiceOutletCode=" + amortizationServiceOutletCode + ", " : "") +
            ...
            (amortizationAmount != null ? "amortizationAmount=" + amortizationAmount + ", " : "") + (numberOfAmortizations != null ? "numberOfAmortizations=" + numberOfAmortizations + ", " : "") +
            (firstAmortizationDate != null ? "firstAmortizationDate=" + firstAmortizationDate + ", " : "") +
            (monthlyAmortizationDate != null ? "monthlyAmortizationDate=" + monthlyAmortizationDate + ", " : "") + (uploadSuccessful != null ? "uploadSuccessful=" + uploadSuccessful + ", " : "") +
            (uploadOrphaned != null ? "uploadOrphaned=" + uploadOrphaned + ", " : "") + (originatingFileToken != null ? "originatingFileToken=" + originatingFileToken + ", " : "") +
