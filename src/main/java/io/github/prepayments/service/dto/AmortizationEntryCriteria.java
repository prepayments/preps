...
public class AmortizationEntryCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(amortizationDate, that.amortizationDate) && Objects.equals(amortizationAmount, that.amortizationAmount) &&
            Objects.equals(particulars, that.particulars) && Objects.equals(prepaymentServiceOutlet, that.prepaymentServiceOutlet) &&
            Objects.equals(prepaymentAccountNumber, that.prepaymentAccountNumber) && Objects.equals(amortizationServiceOutlet, that.amortizationServiceOutlet) &&
            Objects.equals(amortizationAccountNumber, that.amortizationAccountNumber) && Objects.equals(originatingFileToken, that.originatingFileToken) &&
            Objects.equals(amortizationTag, that.amortizationTag) && Objects.equals(orphaned, that.orphaned) && Objects.equals(prepaymentEntryId, that.prepaymentEntryId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, amortizationDate, amortizationAmount, particulars, prepaymentServiceOutlet, prepaymentAccountNumber, amortizationServiceOutlet, amortizationAccountNumber,
                            originatingFileToken, amortizationTag, orphaned, prepaymentEntryId);
    }
    ...
    public String toString() {
        return "AmortizationEntryCriteria{" + (id != null ? "id=" + id + ", " : "") + (amortizationDate != null ? "amortizationDate=" + amortizationDate + ", " : "") +
            ...
            (originatingFileToken != null ? "originatingFileToken=" + originatingFileToken + ", " : "") + (amortizationTag != null ? "amortizationTag=" + amortizationTag + ", " : "") +
            (orphaned != null ? "orphaned=" + orphaned + ", " : "") + (prepaymentEntryId != null ? "prepaymentEntryId=" + prepaymentEntryId + ", " : "") + "}";
    }
