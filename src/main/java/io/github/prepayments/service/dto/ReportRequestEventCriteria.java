...
/**
 * Criteria class for the {@link io.github.prepayments.domain.ReportRequestEvent} entity. This class is used in {@link io.github.prepayments.web.rest.ReportRequestEventResource} to receive all the
 * possible filtering options from the Http GET request parameters. For example the following could be a valid request: {@code /report-request-events?id
...
public class ReportRequestEventCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(reportRequestDate, that.reportRequestDate) && Objects.equals(requestedBy, that.requestedBy) &&
            Objects.equals(reportTypeId, that.reportTypeId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, reportRequestDate, requestedBy, reportTypeId);
    }

    @Override
    public String toString() {
        return "ReportRequestEventCriteria{" + (id != null ? "id=" + id + ", " : "") + (reportRequestDate != null ? "reportRequestDate=" + reportRequestDate + ", " : "") +
            (requestedBy != null ? "requestedBy=" + requestedBy + ", " : "") + (reportTypeId != null ? "reportTypeId=" + reportTypeId + ", " : "") + "}";
    }
