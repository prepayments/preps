...
/**
 * A DTO for the {@link io.github.prepayments.domain.AmortizationDataEntryFile} entity.
 */
public class AmortizationDataEntryFileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        AmortizationDataEntryFileDTO amortizationDataEntryFileDTO = (AmortizationDataEntryFileDTO) o;
        if (amortizationDataEntryFileDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), amortizationDataEntryFileDTO.getId());
    }
    ...
    public String toString() {
        return "AmortizationDataEntryFileDTO{" + "id=" + getId() + ", periodFrom='" + getPeriodFrom() + "'" + ", periodTo='" + getPeriodTo() + "'" + ", dataEntryFile='" + getDataEntryFile() + "'" +
