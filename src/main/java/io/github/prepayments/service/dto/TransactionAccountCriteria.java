...
public class TransactionAccountCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(accountName, that.accountName) && Objects.equals(accountNumber, that.accountNumber) && Objects.equals(accountType, that.accountType) &&
            Objects.equals(openingDate, that.openingDate) && Objects.equals(originatingFileToken, that.originatingFileToken);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, accountName, accountNumber, accountType, openingDate, originatingFileToken);
    }

    @Override
    public String toString() {
        return "TransactionAccountCriteria{" + (id != null ? "id=" + id + ", " : "") + (accountName != null ? "accountName=" + accountName + ", " : "") +
            (accountNumber != null ? "accountNumber=" + accountNumber + ", " : "") + (accountType != null ? "accountType=" + accountType + ", " : "") +
            (openingDate != null ? "openingDate=" + openingDate + ", " : "") + (originatingFileToken != null ? "originatingFileToken=" + originatingFileToken + ", " : "") + "}";
    }
