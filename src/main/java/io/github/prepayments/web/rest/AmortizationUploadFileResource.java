...
@RestController
@RequestMapping("/api")
public class AmortizationUploadFileResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new amortizationUploadFileDTO, or with status {@code 400 (Bad Request)} if the amortizationUploadFile has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated amortizationUploadFileDTO,
     * or with status {@code 400 (Bad Request)} if the amortizationUploadFileDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the amortizationUploadFileDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<AmortizationUploadFileDTO> updateAmortizationUploadFile(@Valid @RequestBody AmortizationUploadFileDTO amortizationUploadFileDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, amortizationUploadFileDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<AmortizationUploadFileDTO>> getAllAmortizationUploadFiles(AmortizationUploadFileCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/amortization-upload-files?query=:query} : search for the amortizationUploadFile corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<AmortizationUploadFileDTO>> searchAmortizationUploadFiles(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
