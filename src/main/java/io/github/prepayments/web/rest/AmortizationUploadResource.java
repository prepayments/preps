...
public class AmortizationUploadResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new amortizationUploadDTO, or with status {@code 400 (Bad Request)} if the amortizationUpload has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated amortizationUploadDTO,
     * or with status {@code 400 (Bad Request)} if the amortizationUploadDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the amortizationUploadDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<AmortizationUploadDTO> updateAmortizationUpload(@Valid @RequestBody AmortizationUploadDTO amortizationUploadDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, amortizationUploadDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<AmortizationUploadDTO>> getAllAmortizationUploads(AmortizationUploadCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    /**
     * {@code SEARCH  /_search/amortization-uploads?query=:query} : search for the amortizationUpload corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<AmortizationUploadDTO>> searchAmortizationUploads(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
