...
public class ReportRequestEventResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new reportRequestEventDTO, or with status {@code 400 (Bad Request)} if the reportRequestEvent has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated reportRequestEventDTO,
     * or with status {@code 400 (Bad Request)} if the reportRequestEventDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the reportRequestEventDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<ReportRequestEventDTO> updateReportRequestEvent(@RequestBody ReportRequestEventDTO reportRequestEventDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportRequestEventDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<ReportRequestEventDTO>> getAllReportRequestEvents(ReportRequestEventCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
