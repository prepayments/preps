...
public class ScannedDocumentResource {
    ...
    public ResponseEntity<ScannedDocumentDTO> createScannedDocument(@Valid @RequestBody ScannedDocumentDTO scannedDocumentDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ScannedDocumentDTO> updateScannedDocument(@Valid @RequestBody ScannedDocumentDTO scannedDocumentDTO) throws URISyntaxException {
