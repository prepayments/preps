...
public class AccountingTransactionResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new accountingTransactionDTO, or with status {@code 400 (Bad Request)} if the accountingTransaction has already an ID.
    ...
    public ResponseEntity<AccountingTransactionDTO> updateAccountingTransaction(@Valid @RequestBody AccountingTransactionDTO accountingTransactionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountingTransactionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<AccountingTransactionDTO>> getAllAccountingTransactions(AccountingTransactionCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<AccountingTransactionDTO>> searchAccountingTransactions(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
