package io.github.prepayments.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(io.github.prepayments.repository..*)" + " || within(io.github.prepayments.service..*)" + " || within(io.github.prepayments.web.rest..*)")
