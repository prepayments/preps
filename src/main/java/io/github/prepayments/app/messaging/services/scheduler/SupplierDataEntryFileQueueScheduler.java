...
public class SupplierDataEntryFileQueueScheduler implements DataEntryFileQueueScheduler<SupplierDataEntryFileDTO> {
     ...
     */
    @Override
    public Observable<Long> deserializeAndEnqueue(final SupplierDataEntryFileDTO dataEntryFile) {
