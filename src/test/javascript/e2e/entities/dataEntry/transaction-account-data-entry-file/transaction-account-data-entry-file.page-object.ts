...
export class TransactionAccountDataEntryFileComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('gha-transaction-account-data-entry-file div table .btn-danger'));
  title = element.all(by.css('gha-transaction-account-data-entry-file div h2#page-heading span')).first();
...
export class TransactionAccountDataEntryFileUpdatePage {
  pageTitle = element(by.id('gha-transaction-account-data-entry-file-heading'));
...
export class TransactionAccountDataEntryFileDeleteDialog {
  private dialogTitle = element(by.id('gha-delete-transactionAccountDataEntryFile-heading'));
  private confirmButton = element(by.id('gha-confirm-delete-transactionAccountDataEntryFile'));
