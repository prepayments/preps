...
export class AmortizationUploadFileComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('gha-amortization-upload-file div table .btn-danger'));
  title = element.all(by.css('gha-amortization-upload-file div h2#page-heading span')).first();
...
export class AmortizationUploadFileUpdatePage {
  pageTitle = element(by.id('gha-amortization-upload-file-heading'));
...
export class AmortizationUploadFileDeleteDialog {
  private dialogTitle = element(by.id('gha-delete-amortizationUploadFile-heading'));
  private confirmButton = element(by.id('gha-confirm-delete-amortizationUploadFile'));
