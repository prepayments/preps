...
export class SupplierDataEntryFileComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('gha-supplier-data-entry-file div table .btn-danger'));
  title = element.all(by.css('gha-supplier-data-entry-file div h2#page-heading span')).first();
...
export class SupplierDataEntryFileUpdatePage {
  pageTitle = element(by.id('gha-supplier-data-entry-file-heading'));
...
export class SupplierDataEntryFileDeleteDialog {
  private dialogTitle = element(by.id('gha-delete-supplierDataEntryFile-heading'));
  private confirmButton = element(by.id('gha-confirm-delete-supplierDataEntryFile'));
