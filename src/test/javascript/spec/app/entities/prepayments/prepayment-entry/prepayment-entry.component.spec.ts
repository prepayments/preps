...
import { PrepaymentEntryComponent } from 'app/entities/prepayments/prepayment-entry/prepayment-entry.component';
...
describe('Component Tests', () => {
  describe('PrepaymentEntry Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.prepaymentEntries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
