...
import { AmortizationEntryComponent } from 'app/entities/prepayments/amortization-entry/amortization-entry.component';
...
describe('Component Tests', () => {
  describe('AmortizationEntry Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.amortizationEntries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
