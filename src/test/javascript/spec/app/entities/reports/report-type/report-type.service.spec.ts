...
import { IReportType, ReportType, ReportMediumTypes } from 'app/shared/model/reports/report-type.model';
...
describe('Service Tests', () => {
  describe('ReportType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ReportType(0, 'AAAAAAA', ReportMediumTypes.EXCEL, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a ReportType', async () => {
        const returnedFromService = Object.assign(
          {
            reportModelName: 'BBBBBB',
            reportMediumType: 'BBBBBB',
