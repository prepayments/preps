...
import { AmortizationEntryUpdateComponent } from 'app/entities/updates/amortization-entry-update/amortization-entry-update.component';
...
describe('Component Tests', () => {
  describe('AmortizationEntryUpdate Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new AmortizationEntryUpdate(123)],
            headers
          })
        )
      );
      ...
      expect(comp.amortizationEntryUpdates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
