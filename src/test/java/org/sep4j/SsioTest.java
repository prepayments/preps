...
import static org.sep4j.Ssio.createRecordInstance;
import static org.sep4j.Ssio.setPropertyWithCellValue;
...
public class SsioTest {
	...
	public void createRecordIndexTest() {
		createRecordInstance(DefaultConstructorBean.class);
		createRecordInstance(PrivateClassBean.class);
	}
	...
	public void createRecordIndexTest_NoDefaultConstructor() {
		...
		createRecordInstance(NoDefaultConstructorBean.class);
	}
	...
	public void setPropertyWithCellTextTest_StrProp() {
		...
		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "strProp", "abc");
		Assert.assertEquals("abc", record.getStrProp());

		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "strProp", null);
	...
	public void setPropertyWithCellTextTest_IntObjProp() {
		...
		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "intObjProp", "123");
		Assert.assertEquals(new Integer(123), record.getIntObjProp());

		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "intObjProp", null);
	...
	public void setPropertyWithCellTextTest_IntObjProp_NotNumer() {
		...
		SsioUnitTestRecord record = new SsioUnitTestRecord();
		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "intObjProp", "abc");
	...
	public void setPropertyWithCellTextTest_PrimIntProp() {
		...
		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "primIntProp", "123");
	...
	public void setPropertyWithCellTextTest_PrimIntProp_NullText() {
		...
		SsioUnitTestRecord record = new SsioUnitTestRecord();
		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "primIntProp", null);
	...
	public void setPropertyWithCellTextTest_PrimIntProp_NotNumber() {
		...
		SsioUnitTestRecord record = new SsioUnitTestRecord();
		setPropertyWithCellValue(SsioUnitTestRecord.class, record, "primIntProp", "abc");
	}
...
//		Cell blankCell = row.createCell(0, Cell.CELL_TYPE_BLANK);
		Cell blankCell = row.createCell(0, CellType.BLANK);
...
//		Cell errCell = row.createCell(2, Cell.CELL_TYPE_ERROR);
		Cell errCell = row.createCell(2, CellType.ERROR);
