...
public class SepShowcases {
	...
	public void saveMaps() throws IOException {
		...
		//You can also let org.sep4j generate a header map for you, by just providing the map's keys
	...
	private File createFile(String prefix) {
		File dir = new File(System.getProperty("java.io.tmpdir"), "/org/sep4j/show-case");
		dir.mkdirs();
